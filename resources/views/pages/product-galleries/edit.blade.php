            ...
            <div class="card-body">
                <form action="{{ route('products.update', $item->id ) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        ">
                        @error('name') <div class="text-mute">{{$massage}}</div> @enderror
                    </div>
                    <div class="form-group">
                        ...
                        @error('type') <div class="text-mute">{{$massage}}</div> @enderror
                    </div>
                    <div class="form-group">
                        ...
                        @error('description') <div class="text-mute">{{$massage}}</div> @enderror
                    </div>
                    <div class="form-group">
                        ...
                        >
                        @error('price') <div class="text-mute">{{$massage}}</div> @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            >
                        @error('quantity') <div class="text-mute">{{$massage}}</div> @enderror
                    </div>
                    <div class="form-group">
